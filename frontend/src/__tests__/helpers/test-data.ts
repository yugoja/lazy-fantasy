...
export const mockMatchPlayersResponse = {
  ...
  team_1_form: [
    { match_id: 31, opponent_short_name: 'ENG', result: 'W', start_time: '2026-04-21T14:00:00Z' },
    { match_id: 29, opponent_short_name: 'NZ', result: 'W', start_time: '2026-04-18T14:00:00Z' },
    { match_id: 27, opponent_short_name: 'SA', result: 'L', start_time: '2026-04-15T14:00:00Z' },
    { match_id: 24, opponent_short_name: 'PAK', result: 'NR', start_time: '2026-04-12T14:00:00Z' },
    { match_id: 20, opponent_short_name: 'SL', result: 'W', start_time: '2026-04-09T14:00:00Z' },
  ],
  team_2_form: [
    { match_id: 32, opponent_short_name: 'NZ', result: 'L', start_time: '2026-04-22T14:00:00Z' },
    { match_id: 30, opponent_short_name: 'ENG', result: 'W', start_time: '2026-04-19T14:00:00Z' },
    { match_id: 28, opponent_short_name: 'SA', result: 'W', start_time: '2026-04-16T14:00:00Z' },
    { match_id: 25, opponent_short_name: 'PAK', result: 'L', start_time: '2026-04-13T14:00:00Z' },
    { match_id: 21, opponent_short_name: 'SL', result: 'W', start_time: '2026-04-10T14:00:00Z' },
  ],
