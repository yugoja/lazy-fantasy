...
export const mockExistingPrediction = {
  ...
  predicted_most_runs_player_id: 101,
  predicted_most_wickets_player_id: 103,
...
export const mockLeagues = [
  { id: 10, name: 'Test League', invite_code: 'ABC123', owner_id: 1 },
  { id: 20, name: 'Another League', invite_code: 'DEF456', owner_id: 2 },
];

export const mockLeaderboardEntries = [
  { user_id: 1, username: 'alice', total_points: 150, rank: 1 },
  { user_id: 2, username: 'bob', total_points: 120, rank: 2 },
  { user_id: 3, username: 'testuser', total_points: 100, rank: 3 },
  { user_id: 4, username: 'dave', total_points: 80, rank: 4 },
];
